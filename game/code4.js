...
gdjs.CreditsCode.GDCursorObjects3= [];
...
gdjs.CreditsCode.mapOfGDgdjs_46CreditsCode_46GDCursorObjects1Objects = Hashtable.newFrom({"Cursor": gdjs.CreditsCode.GDCursorObjects1});gdjs.CreditsCode.eventsList0 = function(runtimeScene) {
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.CreditsCode.mapOfGDgdjs_46CreditsCode_46GDCursorObjects1Objects, gdjs.evtTools.input.getMouseX(runtimeScene, "Cursor", 0), gdjs.evtTools.input.getMouseY(runtimeScene, "Cursor", 0), "Cursor");
}}
...
gdjs.copyArray(runtimeScene.getObjects("Cursor"), gdjs.CreditsCode.GDCursorObjects1);
...
}{for(var i = 0, len = gdjs.CreditsCode.GDCursorObjects1.length ;i < len;++i) {
    gdjs.CreditsCode.GDCursorObjects1[i].setPosition(gdjs.evtTools.input.getMouseX(runtimeScene, "Cursor", 0),gdjs.evtTools.input.getMouseY(runtimeScene, "Cursor", 0));
}
}}
...
gdjs.CreditsCode.GDCursorObjects3.length = 0;
